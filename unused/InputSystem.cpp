...
void InputSystem::Move(shared_ptr<Entity> & entity) {
	shared_ptr<Components::Position> position = entity->GetComponent<Components::Position>("Position");
	shared_ptr<Components::Movement> movement = entity->GetComponent<Components::Position>("Movement");
...
void InputSystem::SyncEntities()
{
}

string InputSystem::Name()
{
	return "Input";
}
