...
P2F main(V2P pixel)
{
	...
	float snowRatio = clamp(pixel.worldPos.y - 128.0, 0.0, 1.0);
	...
	color *= (1 - distanceWeight * 0.3);
	color.r += distanceWeight * 0.15;
	color.g += distanceWeight * 0.15;
	color.b += distanceWeight * 0.3;
