...
HRESULT D3DClass::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear)
{
	HRESULT result = S_OK;
	...
	IDXGIDevice1 *d3d11_Device1;

	
	result = D3D11CreateDeviceAndSwapChain(NULL, D3D_DRIVER_TYPE_HARDWARE, NULL, 0, &featureLevel, 1, 
										   D3D11_SDK_VERSION, &swapChainDesc, &m_swapChain, &m_device, NULL, &m_deviceContext);
	// create d3d11_Device as normal, then
	m_device->QueryInterface(__uuidof (d3d11_Device1), (void **)&d3d11_Device1);
